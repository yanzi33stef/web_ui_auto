...
class IndexPage(BasePage):
    ...
    def get_course_title(self):
        return self.get_ele(self.course_title_locator)

    def get_index_add_course_up_btn(self):
        """加入课程"""
        return self.get_ele(self.index_add_course_up_locator)

    def get_index_add_course_down_btn(self):
        return self.get_ele(self.index_add_course_down_locator)

    def get_add_course_code(self):
        """课程名称"""
        return self.get_ele(self.add_course_code_locator)
    ...
    def get_add_course_cancel_btn(self):
        """取消"""
        return self.get_ele(self.add_course_cancel_locator)
    ...
    def add_course_up(self, course_code):
        ...
        self.get_ele(self.add_course_ok_btn_locator).click()
